...
const BROODY_PER_HEN = TUNING.elders.broodyPerHen;
const BROODY_MAX_HENS = TUNING.elders.broodyMaxHens;

function elderHensOnPond(state: GameState): number {
...
const MENTOR_RADIUS = TUNING.elders.mentorRadius;
